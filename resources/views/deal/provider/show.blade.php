    ...
    <div class="content container-fluid">
        <div class="row">
            ...
            <div class="col-xs-5 text-right m-b-30">
                <form id="delete-provider{{$provider->id}}" method="post" action="{{URL::route('provider.destroy', compact('provider')) }}">
                    {!! method_field('delete') !!}
                    {!! csrf_field() !!}
                </form>
                <a href="#"
                ...
                <a href="{{URL::route('provider.edit', compact('provider')) }}" class="btn btn-primary rounded "><i class="fa fa-plus"></i>
                                ...
                                <div class="card-box project-box">
                                    <div class="dropdown profile-action">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="{{URL::route('provider.edit',compact('provider'))}}" data-toggle="modal" data-target="#edit_project"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
