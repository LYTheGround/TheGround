@if(isset($info))
    {{ Form::model($info,['method' => 'PUT', 'url' => route('provider.update',compact('provider'))]) }}
@else
    {{ Form::open(['method' => 'POST', 'url' => route('provider.store')]) }}
@endif
...
<div class="row">
    <div class="col-xs-12">
        <div class="form-group">
            ...
            {{ Form::textarea('description',(!old('description')) ? (isset($info->provider->description)) ? $info->provider->description : null : old('description'),['class' => 'form-control', 'placeholder' => __('validation.attributes.description')]) }}
