@extends("layouts.app")
@section('page-title')
    {{__('pages.rh.position.index.title')}}
@stop
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="col-sm-4 col-xs-3">
                <h4 class="page-title">{{__('pages.rh.position.index.title')}}</h4>
            </div>
    ...
    @include('rh.position._create_modal',['submit' => __('validation.attributes.edit')])
    @foreach($positions as $position)
        @include('rh.position._edit_modal',['submit' => __('validation.attributes.edit'),'position' => $position])
        @include('rh.position._delete_modal',compact('position'))
    @endforeach
@stop
